      ...
      <div className="wrap02">
        <div className="input">
          <div className="mt-4">
            ...
            <button className="btn btn-primary btn-seg" aria-label="Atualizar senha">Atualizar</button>
          </div>
         
          <div className="my-2">
            <label htmlFor="email">Telefone</label>
            <button className="btn btn-primary btn-seg" aria-label="Atualizar email">Atualizar</button>
          </div>
          <div className="my-2">
